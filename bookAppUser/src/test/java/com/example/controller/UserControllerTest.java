...
public class UserControllerTest {
	...
	//@MockBean to mock away the business logic, since we don’t want to test integration between
	//controller and business logic, but between controller and the HTTP layer
	@MockBean
	...
	public void testRegisterUserSuccess() throws Exception {
		//ObjectMapper to map to and from JSON and a MockMvc instance to simulate HTTP requests.
